...
$(document).ready(function () {
	var cnt = $(".tab_menu li").length;
	$(".tabs .contlist:eq(0)").show(); // 첫번째 탭내용 오푼!
	$(".tabs .tab1").css("background", "blue").css("color", "#fff");
	...
	$(".tabs .tab").each(function (index) {
		$(this).click(function (e) {
			...
			$(".tab").css("background", "red").css("color", "#fff");
			$(this).css("background", "blue").css("color", "#fff");
		});
	});
});
